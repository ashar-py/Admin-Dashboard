...
const UserInfo = (  ) => {
    const { selectedPhoneNo } = useSelectedPhoneNo(); // Use the selectedPhoneNo from context
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const userData = await fetchUserInfo(selectedPhoneNo); // Use selectedPhoneNo here
    ...
    useEffect(() => {
        const fetchChatHistory = async () => {
            try {
                ...
                const history = await retrieveChatHistory(selectedPhoneNo, 'bimakartbike'); // Use selectedPhoneNo here
