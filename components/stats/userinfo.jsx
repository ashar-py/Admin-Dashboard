...
const UserInfo = ({ phoneNumber, prefix }) => { // Add prefix as prop
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const userData = await fetchUserInfo(phoneNumber, prefix); // Use prefix prop
    ...
    fetchData();
  }, [phoneNumber, prefix]); // Update useEffect dependency

  useEffect(() => {
    const fetchChatHistory = async () => {
      try {
        setLoadingChatHistory(true);
        const history = await retrieveChatHistory(phoneNumber, prefix); // Use prefix prop
